    ...
    >
      ...
      >
        <div className="w-full tablet:w-[24rem] mb-2 border bg-[#00000088] rounded-md pt-3 border-main-white/50 items-center">
          ...
          {type === 'gmail' ? (
            <button
              className="flex font-light text-lg tablet:text-xl w-full h-12 tablet:h-14 items-center bg-transparent hover:bg-[#ffffff0f] duration-100 justify-center px-6"
              onClick={(ev) => CopyToClipboard('email')}
            >
              <span
                ref={copyUserText}
                className="flex"
