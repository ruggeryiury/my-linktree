        ...
        <div
            ...
            <div
                ...
                <div className="w-full tablet:w-[24rem] mb-2 border bg-[#00000088] rounded-md pt-3 border-main-white/50 items-center">
                    ...
                    <button className="flex items-center px-4 tablet:px-6 text-start font-light text-lg tablet:text-xl w-full h-12 tablet:h-14 bg-transparent hover:bg-[#ffffff0f] duration-100" onClick={ev => Dispatch(session.actions.update({ settingsModalState: 'lang' }))}>
                        <h1>{t(`language_setting`)}</h1>
                        <div className="ml-auto flex-row items-center">
                            <h2 className="font-medium py-1 text-sm laptop:text-md mr-1 bg-gradient-to-br from-[#1aaeab] to-[#009575] text-transparent bg-clip-text">
                                {t(i18n.language)}
                            </h2>
                ...
                <button className="text-red-500 text-lg tablet:text-xl w-full tablet:w-[24rem] bg-[#00000088] h-12 tablet:h-14 rounded-md border border-red-500 hover:bg-[#000000dd] duration-100" onClick={ev => Dispatch(session.actions.update({ isSettingsActivated: false, settingsModalState: 'closed' }))} >{t('close')}</button>
            </div>
            ...
            <div
                ...
                <div className="w-full tablet:w-[24rem] mb-2 border bg-[#00000088] rounded-md pt-3 border-main-white/50 items-center">
                    ...
                    <button className="flex items-center px-4 tablet:px-6 text-start font-light text-base w-full h-12 tablet:h-14 bg-transparent hover:bg-[#ffffff0f] duration-100" onClick={ev => i18n.changeLanguage('en-US')}>
                        {
                    ...
                    <button className="flex items-center px-4 tablet:px-6 text-start font-light text-base w-full h-12 tablet:h-14 bg-transparent hover:bg-[#ffffff0f] duration-100" onClick={ev => i18n.changeLanguage('pt-BR')}>
                        {
                ...
                <button className="text-red-500 text-lg tablet:text-xl w-full tablet:w-[24rem] bg-[#00000088] h-12 tablet:h-14 rounded-md border border-red-500 hover:bg-[#000000dd] duration-100" onClick={ev => Dispatch(session.actions.update({ settingsModalState: 'init' }))} >{t('return')}</button>
            </div>
        </div>
    )
}
