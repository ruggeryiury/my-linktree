    ...
    >
      ...
      >
        <div className="w-full tablet:w-[24rem] mb-2 border bg-[#00000088] rounded-md pt-3 border-main-white/50 items-center">
          <IoIosSettings
            className={`w-[1.8rem] h-[1.8rem] tablet:w-[2.2rem] tablet:h-[2.2rem] laptop:w-[2.8rem] laptop:h-[2.8rem] mb-2`}
          />
          <h1 className="w-full px-8 font-normal text-sm tablet:text-base text-main-white/75 mb-4">
            {t('settings_title')}
          </h1>
          ...
          >
            ...
            <div className="ml-auto flex-row items-center">
              <h2 className="font-medium py-1 text-sm laptop:text-md mr-1 bg-gradient-to-br from-[#1aaeab] to-[#009575] text-transparent bg-clip-text">
                {t(i18n.language.includes('-') ? i18n.language.slice(0, 2) : i18n.language)}
              </h2>
      ...
      >
        <div className="w-full tablet:w-[24rem] mb-2 border bg-[#00000088] rounded-md pt-3 border-main-white/50 items-center">
          <IoIosSettings
            className={`w-[1.8rem] h-[1.8rem] tablet:w-[2.2rem] tablet:h-[2.2rem] laptop:w-[2.8rem] laptop:h-[2.8rem] mb-2`}
          />
          <h1 className="w-full px-8 font-normal text-sm tablet:text-base text-main-white/75 mb-4">{`${t(
            'settings_title'
          )}/${t('language_setting')}`}</h1>
          <div className="bg-[#333] w-full h-[1px]" />
          ...
          >
            {i18n.language.includes('en') ? (
              <IoIosCheckboxOutline className="mr-2 text-xl" />
            ) : (
              <IoIosSquareOutline className="mr-2 text-xl" />
            )}
            {t('en')}
          </button>
